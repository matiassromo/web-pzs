...
const highlights = [
    ...
    { icon: TrendingUp, text: 'Mejora tu técnica, resistencia y confianza' },
            ...
            >
                    ...
                    <div className="bg-brand-dark p-8 text-center">
                        ...
                        <h3 className="text-2xl font-display font-bold text-white mb-1">
                            Cursos Vacacionales Intensivos de Natación
                        </h3>
                        <p className="text-brand-light font-semibold mb-3">Lunes a Viernes — ¡Constancia que te hace mejor!</p>
                        <p className="text-white/80 text-sm italic">Este verano aprende, mejora y disfruta del agua</p>
                    </div>
