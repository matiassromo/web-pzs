function mostrarModal(servicio) {
  ...
  const datos = {
    ...
    Cursos: {
      ...
      descripcion: "Inscríbete en nuestros <strong>cursos permanentes</strong> para aprender a nadar con instructores certificados. Ideal para niños, jóvenes y adultos. <br><strong>Horarios:</strong> Martes y Jueves de 16h00 a 17h00. <em>Consulta disponibilidad de cupos, ¡se llenan rápido!</em>"
    },
    Reservaciones: {
